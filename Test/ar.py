...
data_path = Path("C:/research/TJM/TransformerJM/datasets/ar/r_data_ar_1.csv")
...
output_dir = "C:/research/TJM/TransformerJM/datasets/arp/"  # Replace with your desired output directory
...
for dataset_file in os.listdir("C:/research/TJM/TransformerJM/datasets/ar"):  # Replace with your dataset directory
    if dataset_file.endswith(".csv"):
        dataset_path = os.path.join("C:/research/TJM/TransformerJM/datasets/ar", dataset_file)
