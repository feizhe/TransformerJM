...
data_path = Path("C:/research/TJM/TransformerJM/datasets/nl10/r_data_nl10_1.csv")
...
output_dir = "C:/research/TJM/TransformerJM/datasets/prednl10/"  # Replace with your desired output directory
...
for dataset_file in os.listdir("C:/research/TJM/TransformerJM/datasets/nl10"):  # Replace with your dataset directory
    if dataset_file.endswith(".csv"):
        dataset_path = os.path.join("C:/research/TJM/TransformerJM/datasets/nl10", dataset_file)
