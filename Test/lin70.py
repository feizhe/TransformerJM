...
data_path = Path("C:/research/TJM/TransformerJM/datasets/l70/r_data_lin70_1.csv")
...
output_dir = "C:/research/TJM/TransformerJM/datasets/pred70/"  # Replace with your desired output directory
...
for dataset_file in os.listdir("C:/research/TJM/TransformerJM/datasets/l70"):  # Replace with your dataset directory
    if dataset_file.endswith(".csv"):
        dataset_path = os.path.join("C:/research/TJM/TransformerJM/datasets/l70", dataset_file)
